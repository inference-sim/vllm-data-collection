...
def train_lr(model_name, run_folder_name):
    ...
    with open(f'results_new/{model_name}/{run_folder_name}/results/scenario2_output_train.json', 'r') as f:
        train_data = json.load(f)

    with open(f'results_new/{model_name}/{run_folder_name}/results/scenario2_output_test.json', 'r') as file:
